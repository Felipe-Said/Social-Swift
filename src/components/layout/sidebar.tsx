...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <motion.aside
      ...
      className={cn(
        "flex min-h-full w-full flex-col gap-2 bg-[hsl(var(--surface-solid))] px-2 py-4 shadow-none lg:sticky lg:top-[72px] lg:min-h-[calc(100vh-88px)] lg:rounded-none lg:border-none lg:bg-transparent",
        className
      )}
    >
